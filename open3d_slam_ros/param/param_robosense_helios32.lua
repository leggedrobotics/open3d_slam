...
params.odometry.scan_processing.scan_cropping.cropping_radius_max = 80.0
...
params.mapper_localizer.scan_to_map_registration.scan_processing.voxel_size = 0.12
...
--DENSE_MAP_BUILDER
params.dense_map_builder.map_voxel_size = 0.04
params.dense_map_builder.scan_cropping.cropping_radius_max = 16.0
params.dense_map_builder.space_carving.carve_space_every_n_scans = 1000
