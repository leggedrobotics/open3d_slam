...
enum class CroppingVolumeEnum : int { MaxRadius, MinRadius, Cylinder, MinMaxRadius };

static const std::map<std::string, CroppingVolumeEnum> cropperNames{{"MaxRadius", CroppingVolumeEnum::MaxRadius},
