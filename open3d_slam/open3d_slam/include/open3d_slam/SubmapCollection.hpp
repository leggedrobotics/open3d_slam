...
class SubmapCollection {
 ...
 public:
  ...
  bool insertScan(const PointCloud& rawScan, const PointCloud& preProcessedScan, const Transform& mapToRangeSensor, const Matrix6d& covariance, const Time& timestamp);
